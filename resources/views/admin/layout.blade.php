...
<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/admin_assets/dist/css/styles.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <a href="{{url('/')}}/admin_assets/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="{{url('/')}}/admin_assets/#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="{{url('/')}}/admin_assets/#">
                                            <div class="pull-left">
                                                <img src="{{url('/')}}/admin_assets/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="{{url('/')}}/admin_assets/#">
                                            <div class="pull-left">
                                                <img src="{{url('/')}}/admin_assets/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                            ...
                            <li class="footer"><a href="{{url('/')}}/admin_assets/#">See All Messages</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="{{url('/')}}/admin_assets/#">View all</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown tasks-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="{{url('/')}}/admin_assets/#">View all tasks</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-body">
                                <div class="row">
                                    <div class="col-xs-4 text-center">
                                        <a href="{{url('/')}}/admin_assets/#">Followers</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="{{url('/')}}/admin_assets/#">Sales</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="{{url('/')}}/admin_assets/#">Friends</a>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </li>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{url('/')}}/admin_assets/#" class="btn btn-default btn-flat">Profile</a>
                                </div>
                    ...
                    <li>
                        <a href="{{url('/')}}/admin_assets/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{Carbon\Carbon::now()->format('Y')}} <a href="https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
        reserved.
    </footer>
    ...
    <aside class="control-sidebar control-sidebar-dark">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li><a href="{{url('/')}}/admin_assets/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
            <li><a href="{{url('/')}}/admin_assets/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            <div class="tab-pane" id="control-sidebar-home-tab">
                ...
                <ul class="control-sidebar-menu">
                    <li>
                        <a href="{{url('/')}}/admin_assets/javascript:void(0)">
            ...
            <div class="tab-pane" id="control-sidebar-settings-tab">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            Delete chat history
                            <a href="{{url('/')}}/admin_assets/javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
                        </label>
                    </div>
                    <!-- /.form-group -->
                </form>
